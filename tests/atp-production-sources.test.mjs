...
assert.equal(balance.demands.length, 1);
assert.deepEqual(
    balance.demands[0],
    {
        id: "pondAnchoring",
...
console.log(
    "PASS: ATP production stacks base 1, Energy Kinase 2, Glycolysis Core 4, and a fixed 0.3 ATP/min per correct enzyme; the ledger exposes inactive anchoring demand and no capacity increase."
);
