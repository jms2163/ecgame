...
import NaturalSelectionDataPanel
...
import NaturalSelectionClassComparisonPanel
    from "./NaturalSelectionClassComparisonPanel.js";
...
const NaturalSelectionView = {
    ...
    initialize() {
        ...
        if (
            !NaturalSelectionClassComparisonPanel
                .initialize()
        ) {
            return;
        }
